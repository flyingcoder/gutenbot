...
class GutenBot_Indexer {
    ...
    public static function reindex_post($post) {
        global $wpdb;
        ...
        self::index_sections($post->ID, $layout_id, $blocks);
    }
    ...
    private static function index_sections(int $post_id, int $layout_id, array $blocks) {
        global $wpdb;
        ...
        foreach ($blocks as $block) {
            ...
            $wpdb->insert(
                ...
                [
                    ...
                    'block_markup'   => serialize_blocks([$block]),
